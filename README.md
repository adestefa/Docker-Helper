...
check                          manual check d.txt file data is valid
who                            manual check d.txt file data is valid
...
docs:fastapi                   cli" - open Fastapi documentation
docs:learn                     Open Python learning documentation
docs:reference                 Open FastAPI reference documentation
